...
from gui.widgets.py_list_edit_dialog.py_list_edit_dialog import PyListEditDialog
...
class PyLists(QWidget):
    ...
    def __init__(
        ...
        self.setMaximumHeight(35 + PyLists.MAXIMUM_HEIGHT)
    ...
    def setup_ui(self):
        ...
        # self.list_view_expandable.setMaximumHeight(45*PyLists.TASK)
        ...
        self.list_button.setContextMenuPolicy(Qt.CustomContextMenu)
        ...
        self.widget = QWidget()
        # self.widget.setMaximumHeight(45*PyLists.TASK)
    ...
    def function_ui(self):
        ...
        self.list_button.customContextMenuRequested.connect(self.list_edit_dialog)

    def list_edit_dialog(self):
        self.dialog = PyListEditDialog()
        self.dialog.exec_()

    def expand_animation(self):
        if PyLists.IS_EXPANDED:
            # WIDGET HEIGHT
            # PyLists.MAXIMUM_HEIGHT = self.widget.height()
            self.widget.setMaximumHeight(0)
            self.setMaximumHeight(70)
            PyLists.IS_EXPANDED = False
        else:
            self.widget.setMaximumHeight(PyLists.MAXIMUM_HEIGHT)
            self.setMaximumHeight(PyLists.MAXIMUM_HEIGHT + 40)
            PyLists.IS_EXPANDED = True
