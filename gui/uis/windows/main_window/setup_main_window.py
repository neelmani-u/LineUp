...
from gui.widgets.py_create_group_expandable.py_create_group import PyCreateGroup
...
from gui.apps.task_manager import PyTaskManager
from gui.apps.link_manager import PyLinkManager
from gui.apps.hotkeys_manger import PyHotKeysManager
...
class SetupMainWindow:
    ...
    add_left_menus = [
        ...
        # },
        {
            "btn_icon": "icon_task_tick.svg",
            "btn_id": "btn_tasks",
            "btn_text": "Task Manager",
            "btn_tooltip": "Task Manager",
            "show_top": True,
            "is_active": False
        },
        {
            "btn_icon": "icon_link_book.svg",
            "btn_id": "btn_link_book",
            "btn_text": "Link Book",
            "btn_tooltip": "Link Book",
            "show_top": True,
            "is_active": False
        },
        {
            "btn_icon": "icon_hotkey.svg",
            "btn_id": "btn_hotkeys",
            "btn_text": "HotKeys",
            "btn_tooltip": "HotKeys",
            "show_top": True,
        ...
        # {
        #     "btn_icon": "icon_automation.svg",
        #     "btn_id": "btn_automata",
        #     "btn_text": "Automata",
        #     "btn_tooltip": "Automata",
        #     "show_top": True,
        #     "is_active": False
        # },
        # {
        #     "btn_icon": "icon_power_board.svg",
        #     "btn_id": "btn_power_board",
        #     "btn_text": "Power Board",
        #     "btn_tooltip": "Power Board",
        #     "show_top": True,
        #     "is_active": False
        # },
        # {
    ...
    def setup_gui(self):
        ...
        if self.settings["custom_title_bar"]:
            ...
            self.ui.title_bar.set_title("Welcome to LineUp")
        ...
        # ///////////////////////////////////////////////////////////////
        MainFunctions.set_page(self, self.ui.load_pages.task_manager_page)
        ...
        # self.logo_svg = QSvgWidget(Functions.set_svg_image("logo_lineup.svg"))
        # self.ui.load_pages.logo_layout.addWidget(self.logo_svg, Qt.AlignCenter, Qt.AlignCenter)

        # PAGE 2 - TASK MANAGER
        self.task_manager_page = PyTaskManager(self.ui.load_pages.task_manager_page)
        self.ui.load_pages.task_manager_page_layout.addWidget(self.task_manager_page)

        # PAGE 3 - LINK MANAGER
        self.link_manager_page = PyLinkManager(self.ui.load_pages.link_book_page)
        self.ui.load_pages.link_book_page_layout.addWidget(self.link_manager_page)

        # PAGE 3 - HOTKEYS MANAGER
        self.hotkeys_manager_page = PyHotKeysManager(self.ui.load_pages.hotkeys_page)
        self.ui.load_pages.hotkeys_page_layout.addWidget(self.hotkeys_manager_page)
